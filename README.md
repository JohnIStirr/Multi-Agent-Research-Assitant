...
* Designed and developed a multi-agent AI research platform using Python, AutoGen, and OpenAI that automates academic literature review through coordinated AI agents for paper discovery, analysis, synthesis, and research gap identification.
